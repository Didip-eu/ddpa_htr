...
def test_model_decode():
    network_output = np.array([[-2.1577506, -2.4033802, -3.1110797, -1.9402646, -2.0998254,
                                -2.63057  , -2.2995133, -3.003648 , -2.8692765, -2.5694218],
                               [-2.5967445, -3.49689  , -2.9399962, -3.1172242, -2.7738907,
                                -3.9912455, -3.5913873, -3.3765142, -2.2684784, -3.2620287],
                               [-3.4117193, -3.3247042, -4.0848   , -3.5203876, -3.2172518,
                                -2.5073898, -2.889554 , -3.3295877, -2.746986 , -3.1198492],
                               [-1.6278616, -1.2983577, -1.5978011, -2.3003535, -1.5130877,
                                -1.695713 , -1.9486556, -1.5438657, -2.1168454, -1.5031735],
                               [-3.1382027, -3.3764248, -2.105332 , -2.8138309, -2.826167 ,
                                -3.27912  , -2.5161686, -2.6481047, -2.8865762, -2.5390067],
                               [-2.018828 , -2.0418115, -1.4159603, -2.1193213, -1.7868809,
                                -2.30061  , -1.326269 , -1.565183 , -1.5320983, -1.962064 ],
                               [-1.8722607, -2.3883576, -2.2617729, -2.855318 , -2.1102426,
                                -2.038532 , -2.4088457, -2.5124578, -2.6301372, -2.0920002],
                               [-3.3453794, -3.2000327, -2.7664754, -3.5710936, -3.0939007,
                                -3.635675 , -3.4741216, -3.2699413, -4.17768  , -2.8730369],
                               [-2.542821 , -1.7844386, -2.5300303, -2.026345 , -2.4741833,
                                -1.8136001, -2.2097301, -2.4627254, -1.7341547, -2.1094844],
                               [-1.9897654, -2.2448957, -2.6281688, -1.256404 , -2.5597622,
                                -1.676508 , -2.3310556, -1.6996291, -2.1247885, -2.3254204]],
                                dtype=float32)
    
    model_spec = '[4,128,0,3 Cr3,13,32 Mp2,2 Cr3,13,32 Do0.1,2 Mp2,2 Cr3,9,64 Do0.1,2 Mp2,2 Cr3,9,64 Do0.1,2 S1(1x0)1,3 Lbx200 Do0.1,2 Lbx200 Do0.1,2 Lbx200 Do]'
    model = model_htr.HTR_Model( standalone_alphabet, model_spec=model_spec )
    assert model.decode( network_output ).shape = (10,4)
